    ...
    <div class="auth-layout">
      ...
      <div class="form-column">
        <div class="form-container">
          ...
          <p class="subtitle">Hari ini adalah hari yang baru! Mari lanjutkan misi penyelamatan kucing.</p>
          ...
          <form @submit.prevent="handleLogin">
            ...
            <div class="forgot-password">
              <RouterLink to="/lupa-sandi">Lupa Sandi?</RouterLink>
            </div>
            ...
            <SocialButton>
              <template #icon>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                  ...
                  <path fill="#fff" d="M26.572,29.036h-5.457v-14.209h5.457c0,0,0-2.28,0-4.028c0-2.062,0.915-4.09,4.408-4.09h3.763v5.278h-2.373c-2.25,0-2.848,1.039-2.848,2.984V29.036z"></path>
                </svg>
              </template>
...
import { authStore } from '../store/authStore.js' // Import Store
...
export default {
  ...
  setup() {
    ...
    const handleLogin = () => {
      // Panggil fungsi login dari store
